...
namespace GUILib
{
	...
	class StyleParser
	{
		...
		{
			if (!this.isInitialized) LayerManager.Instance.LogWarning("[StyleParser] Call of GetStyle() before parser was initialized.");
			...
			{
				LayerManager.Instance.LogError("[StyleParser] Can not find style for identifier '" + identifier + "' returning null instead!");
				return null;
			}
		}
		...
		{
			if (!this.isInitialized) LayerManager.Instance.LogWarning("[StyleParser] Call of UpdateStyle() before parser was initialized.");
			...
			{
				LayerManager.Instance.LogError("[StyleParser] Can not find style for identifier '" + identifier + "'. Doing nothing!");
			}
		}
		...
		private void parseTextAsset(TextAsset stylesheet)
		{
			...
			{
				LayerManager.Instance.LogError("[StyleParser] Error while opening " + stylesheet.name + " with Exception: " + readException.ToString());
			}
