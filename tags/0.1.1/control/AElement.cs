...
namespace GUILib
{
	...
	/// <version>$Rev: 279 $, $Date: 2011-07-24 16:26:34 +0200 (So, 24 Jul 2011) $</version>
	public abstract class AElement : IElement, IMouseEvents
	{
		...
		public bool IsFocused
		{
			...
			get { return (this == OverlayManager.Instance.FocusControl); }
		}
		...
		{
			get { return this.isHovered && (!OverlayManager.Instance.Dragging || OverlayManager.Instance.AcceptingElement == this); }
		}
		...
		{
			get { return (this == OverlayManager.Instance.ActiveControl); }
		}
		...
		/// <summary>
		/// This method is being called when the OverlayManager determines that the element
