...
namespace GUILib 
{
	...
	public abstract class AOverlay : IElementCollection, IKeyEvents
	{
		...
		public int ZIndex 
		{
			...
			set
			{
				bool specialOverride = (OverlayManager.Instance.Console != null && OverlayManager.Instance.Console.ConsoleOverlay == this);
		...
		{
			return this.keyDownStorage != null && keyDownStorage(null, key);
		}

		public virtual bool OnKeyUp (KeyCode key)
		{
			return this.keyUpStorage != null && keyUpStorage(null, key);
		}
