...
{
	/// <summary>
	/// IElementCollection dummy to store single elements out of overlay context.
	/// </summary>
	...
	public abstract class ACollectionDummy : IElementCollection
	{
		...
		{
			get { return true; }
			set { OverlayManager.Instance.LogWarning(this.ToString() + " is a wrapper. Enabled property has no effect."); }
		}
